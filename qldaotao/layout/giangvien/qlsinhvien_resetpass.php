<h2 class=" text-center text-danger">Cấp lại mật khẩu sinh viên</h2>
<hr>
<div class="row">
	<center>
	...
	<form class="form-horizontal" action="index.php?page=qlsinhvien&act=resetpass&sv_id=<?php echo $sv_id; ?>" method="post">
