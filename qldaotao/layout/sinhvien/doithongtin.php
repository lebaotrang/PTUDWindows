...
<div class="row">
	...
	<form class="form-horizontal" action="index.php?page=qltaikhoan&act=edit" method="post">
	    ...
	    <div class="col-md-6">
	        ...
	        <div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="email" name="txtEmail" placeholder="Email..." class="form-control" value="<?php echo isset($sinhvien->sv_email) ? $sinhvien->sv_email : '';?>">
					</div>
				</div>
