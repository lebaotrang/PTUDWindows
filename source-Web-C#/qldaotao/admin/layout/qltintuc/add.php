<script language="javascript">
	$(document).ready(function() {
        $('#slCategory').change(function() {
            $.get('ajax/ajax-tt-quanhuyen.php', $('#tt-add').serialize(), function(e) {
                if( e ) {
                    $('#dsQuanHuyen').html(e);
                }	
            });
...
<div class="container">
<form class="form-horizontal" action="index.php?page=qltintuc&act=add" method="post" enctype="multipart/form-data" id="tt-add">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<input type="text" name="people" placeholder="Người đăng" id="short" class="form-control" value="<?php if (isset($people)) echo $people; ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<?php if($slbannganh==0) showBNList_add($con); else showBNList($con, $slbannganh); ?>
						</div>
					</div>
