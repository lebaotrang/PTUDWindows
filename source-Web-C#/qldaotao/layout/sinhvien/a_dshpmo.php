			...
			<tfoot>
				<tr>
					<td colspan="4" class="text-center">
						<input type="submit" name="submitHP" value="Đăng ký" class="btn btn-info" id="submitHP" <?php echo $disabled; ?>>
					</td>
				</tr>
			</tfoot>
	...
	<div class="col-lg-6">
		...
		<table class="table table-bordered table-responsive" style="margin-bottom: 0px;">
			...
			<tfoot>
				<tr>
					<td colspan="4" class="text-center">
						<input type="submit" name="submitHuyHP" value="Hủy đăng ký" class="btn btn-danger" id="submitHuyHP" <?php echo $disabled; ?>>
					</td>
				</tr>
			</tfoot>
