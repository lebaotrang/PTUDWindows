<h2 class=" text-center text-danger">Đổi mật khẩu sinh viên online</h2>
<hr>
<div class="row">
	<center>
	...
	<form class="form-horizontal" action="index.php?page=doimatkhau" method="post">
	    ...
	    <div class="col-md-6">
	        ...
	        <div class="panel-body">
	            <div class="form-group">
					...
					<div class="col-lg-9">
						<input type="password" name="txtMKCu" placeholder="Nhập mật khẩu cũ..." class="form-control" value="<?php //echo set_value('txtMKCu');?>" required>
					</div>
				</div>
