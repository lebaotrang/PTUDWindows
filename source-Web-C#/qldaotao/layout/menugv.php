...
<nav class="navbar navbar-inverse" role="navigation"><!-- Static navbar -->
	...
	<div class="navbar-collapse collapse" id="navbarCollapse">
		<ul class="nav navbar-nav">
			...
			<?php 
			if (in_array(3, $_SESSION['user_quyen'])) { ?>
				<li class="<?php if($page=='qllopday') echo "active"; ?>"><a href="index.php?page=qllopday">QL.Lớp dạy</a></li>
				<?php
			} ?>
			<li class="<?php if($page=='doimatkhau') echo "active"; ?>"><a href="index.php?page=doimatkhau">Đổi pass</a></li>
			<li class="<?php if($page=='lienhe') echo "active"; ?>"><a href="index.php?page=logout">LogOut</a></li>
		</ul>
				...
				<div class="form-group">
				  ...
				  <table>
					<tr>
						...
						<td><input type="text" placeholder="Từ cần tìm..." class="form-control" name="keyword"></td>
