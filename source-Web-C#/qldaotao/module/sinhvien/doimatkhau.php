...
if(isset($_POST['submit'])){
	...
	if($old_pass!=NULL && $new_pass1!=NULL && $new_pass2!=NULL){
		...
		if(preg_match($pattern, $new_pass1, $match) == 0)
			...
			if($new_pass1!=$new_pass2)
				...
				$sql="select * from sinhvien where sv_matkhau = '$old_pass' and sv_email='".$_SESSION['user_name']."'";
				//echo $sql;
	...
	if(!empty($fail))
		...
		$sql1="UPDATE sinhvien SET sv_matkhau='$new_pass1' WHERE sv_email='$_SESSION[user_name]'";
...
include_once "./layout/sinhvien/doimatkhau.php";
?>